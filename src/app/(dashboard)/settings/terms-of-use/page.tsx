...
return (
    <div className="p-4 text-secondary md:bg-gray-50 rounded-sm"> 
        ...
        <div className="w-full max-w-md flex justify-between items-center mb-8 mt-4  md:hidden">
            <Back />
            <h1 className="text-xl font-medium text-center flex-grow">Terms of Use</h1>
        </div>


        <h1 className="text-xl font-bold text-secondary mb-4 hidden md:block">Terms of Use</h1>
