...
const [desktopNotificationEnabled, setDesktopNotificationEnabled] = useState<boolean>(true);
...
return (
    <div className="md:bg-gray-50 rounded-sm">
        ...
        <div className="hidden md:block p-4">
                {/* Desktop Header for this section - Hidden on Mobile */}
            <h2 className="hidden md:block text-xl font-bold p-4">Receive Notifications</h2>
            ...
            <div className="p-4 space-y-4"> 
                    ...
                    <div className="flex items-center justify-between pb-4">
                        <div className="flex flex-col">
                            <span className="text-base font-medium text-secondary">Language</span>
                    ...
                    <div className="flex items-center justify-between pb-4">
                        <div className="flex flex-col">
                        <span className="text-base font-medium text-secondary">Mobile Push Notifications</span>
                        <span className="text-sm text-place">Receive push notification</span>
                        </div>
                        <Switch
                            checked={mobilePushEnabled}
                            onCheckedChange={setMobilePushEnabled}
                            className={`${mobilePushEnabled ? 'bg-green-400' : 'bg-gray-200'}`}
                        />
                    </div>
                    ...
                    <div className="flex items-center justify-between pb-4">
                        <div className="flex flex-col">
                            <span className="text-base font-medium text-secondary">Desktop Notification</span>
                            <span className="text-sm text-place">Receive push notification in desktop</span>
                        </div>
                        <Switch
                            checked={desktopNotificationEnabled}
                            onCheckedChange={setDesktopNotificationEnabled}
                            className={`${desktopNotificationEnabled ? 'bg-green-400' : 'bg-gray-200'}`}
                        />
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex flex-col">
                            <span className="text-base font-medium text-secondary">Email Notifications</span>
                            <span className="text-sm text-place">Receive email notification</span>
                        </div>
                        <Switch
                            checked={emailNotificationsEnabled}
                            onCheckedChange={setEmailNotificationsEnabled}
                            className={`${emailNotificationsEnabled ? 'bg-green-400' : 'bg-gray-200'}`}
                        />
                    </div>
            </div>
        </div>
